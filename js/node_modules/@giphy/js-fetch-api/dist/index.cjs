...
var GiphyFetch = class {
  constructor(apiKey, qsParams = {}) {
     ...
     */
    this.getQS = (options = {}) => {
      return import_qs.default.stringify(__spreadValues(__spreadProps(__spreadValues({}, options), { api_key: this.apiKey, pingback_id: (0, import_js_util.getPingbackId)() }), this.qsParams));
    };
    this.apiKey = apiKey;
